...
import { PresetSummaryBar } from './components/PresetSummaryBar'
import './App.css'
...
function App() {
  ...
  function handleLoad(i: ScenarioInputs) {
    Object.entries(i).forEach(([k, v]) =>
      handleChange(k as keyof ScenarioInputs, v as ScenarioInputs[keyof ScenarioInputs]))
  }

  return (
    <div className="app-shell">
      <HeaderToolbar currentInputs={inputs} onLoad={handleLoad} />
